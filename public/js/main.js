...
var wrapperH = $('.do-homepage-2nd header').height();

	if(windowH > wrapperH) {
	    $('.do-homepage-2nd header').css({'height':($(window).height())+'px'});
	}
	...
	$(window).resize(function(){
	    ...
	    if(windowH <= truecontentH) {
	        $('.do-homepage-2nd header').css('height', (newH)+'px');
